...
\hypersetup{
  pdftitle={Best practices and practical applications for salmon data mobilization---a practical guide for salmon biologists assuming responsibility for data stewardship},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
mobilization---a practical guide for salmon biologists assuming
