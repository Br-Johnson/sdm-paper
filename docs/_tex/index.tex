...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, breakable, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Critical Functions of Salmon Data Stewards}, arc=.35mm, toptitle=1mm, left=2mm]
