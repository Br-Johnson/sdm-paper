...
\makeatother
\subtitle{DRAFT A Blueprint for Domain-Specific Best Practice}
...
increasingly generate vast and diverse data crucial for timely
decision-making. Yet these data remain largely fragmented across
jurisdictions, disciplines, and outdated infrastructure, limiting their
use in responsive fisheries management. This is precisely the work of
data stewardship---making scattered, cross‑jurisdictional data usable
across systems. Biologists are increasingly taking on data stewardship
...
do so---we develop seven practices for salmon data stewardship. Through
...
and management efficacy. We provide practical guidance for those
transitioning into these essential stewardship roles, including
domain-specific tools, templates, and examples from salmon research and
management. We argue that effective salmon management depends on
formally recognizing data stewardship as an institutionally supported
responsibility. These practices integrate both sociocultural and
technical approaches to ensure data meet modern open science principles
and respect Indigenous Data Sovereignty. With a foundation of shared
practices, data stewards will enable faster, more transparent
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, rightrule=.15mm, coltitle=black, bottomtitle=1mm, toprule=.15mm, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Critical Functions of Salmon Data Stewards}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, arc=.35mm, titlerule=0mm]
