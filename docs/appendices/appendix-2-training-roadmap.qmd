...
- Read the [SMN data package specification](https://github.com/dfo-pacific-science/smn-data-pkg/blob/main/SPECIFICATION.md).
- Review the [DFO Salmon Ontology](https://dfo-pacific-science.github.io/dfo-salmon-ontology/) landing page and identify relevant terms for one dataset.
...
- Build one versioned dataset package using metasalmon + the SMN specification.
- Map at least 10 core fields to stable terms in the DFO Salmon Ontology.
