...
Use this practical checklist to assess how well your project, program, or organization aligns to the seven Best Practices in index.qmd. Start at the Project level, then scale to Program and Organization. Check off items you’ve completed and note gaps to prioritize.
...
-   Project
    -   Do you have a lightweight Data Management Plan (DMP) covering scope, sensitive data, retention, and sharing? (link)
    -   Is there a RACI (Responsible, Accountable, Consulted, Informed) table for key tasks? (owner)
    -   Are Indigenous Data Sovereignty requirements identified and documented (who to consult, approvals needed)?
...
Evidence to collect: LICENSE, CITATION.cff, reuse dashboard link, policy excerpts, sample citations in reports.
