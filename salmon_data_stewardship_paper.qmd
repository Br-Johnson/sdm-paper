...
Salmon research, management and conservation increasingly generates vast and diverse data critical to effective decision making in resource management. However, these data remain largely fragmented across jurisdictions, disciplines and legacy infrastructures, limiting their use in responsive fisheries management. Biologists are increasingly taking on the responsibilities of data stewards to address these challenges, often without formal guidance or institutional support. To address this gap, we present seven best practices for salmon data stewardship and demonstrate through a real-world case study. We provide practical guidance for those transitioning into stewardship roles, including domain-specific tools, templates, and examples in salmon research and management. We argue that effective salmon management depends upon formally establishing data stewardship as a dedicated, institutionally supported professional role. Our best practices integrate both socio-cultural and technical approaches to ensure that salmon data align with modern open science principles and respect Indigenous Data Sovereignty. Through a case study analyzing sockeye salmon productivity across Pacific Coast jurisdictions, we highlight how clearly defined stewardship practices can enhance data reproducibility, integration, and management efficacy. With a foundation of shared best practices, salmon data stewards will enable faster, more transparent decision-making, support development of tools that leverage recent advances in artificial intelligence, and expand the use of a broader, cross-jurisdictional datasets, ---ultimately strengthening the management and conservation of salmon populations and the ecosystems they inhabit.
...
(Example: A DFO document is published on the forecast results with all original data listed in the same document. <https://publications.gc.ca/collections/collection_2024/mpo-dfo/Fs97-6-3496-eng.pdf>)
