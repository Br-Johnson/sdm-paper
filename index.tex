...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Critical Functions of Salmon Data Stewards}, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, left=2mm, leftrule=.75mm, titlerule=0mm, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toptitle=1mm, coltitle=black, rightrule=.15mm, toprule=.15mm, colback=white]
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.8932}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.1068}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Best Practice} \textbar{} \textbf{Plan} \textbar{}
\textbf{Obtain} \textbar{} \textbf{Process} \textbar{} \textbf{Preserve}
\textbar{} \textbf{Access} \textbar{} \textbf{Disposition} \textbar{}
\textbf{Cross-cutting} \textbar{}
:=================:+:========:+:=========:+:=========:+:==========:+:=========:+:============:+:================:+
\textbf{1. Data Governance} \textbar{} ● \textbar{} ● \textbar{} ●
\textbar{} ● \textbar{} ● \textbar{} ● \textbar{} Document, Quality
\textbar{} & \\
\textbf{2. Reuse Infrastructure} \textbar{} ● \textbar{} \textbar{} & ●
\textbar{} ● \textbar{} \textbar{} Track and Monitor \textbar{} \\
\textbf{3. Persistent Identifiers} \textbar{} ● \textbar{} & ●
\textbar{} ● \textbar{} ● \textbar{} \textbar{} Document, Track
\textbar{} \\
\textbf{4. Shared Data Models} \textbar{} ● \textbar{} \textbar{} ● & ●
\textbar{} \textbar{} \textbar{} Quality \textbar{} \\
\textbf{5. Accessible Storage} \textbar{} \textbar{} \textbar{} ●
\textbar{} ● \textbar{} ● \textbar{} \textbar{} Security, Quality
\textbar{} & \\
\textbf{6. Incentivize Sharing} \textbar{} ● \textbar{} \textbar{}
\textbar{} ● \textbar{} ● \textbar{} \textbar{} Track and Monitor
\textbar{} & \\
\textbf{7. Community Building} \textbar{} ● \textbar{} ● \textbar{} ●
\textbar{} ● \textbar{} ● \textbar{} ● \textbar{} Document, Quality
\textbar{} & \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4604}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2939}}@{}}
