...
Salmon data stewards can improve outcomes for salmon by coordinating across boundaries to develop a shared foundation of data stewardship practices. To address these foundational challenges, it is important to establish clear data stewardship roles and practices that span the entire data lifecycle and salmon lifecycle—from collection and documentation through integration, long-term preservation, and reuse and from gravel to estuary and the high seas back to the gravel.
