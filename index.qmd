...
A Data Management Plan (DMP) explains how data will be collected, documented, stored, and preserved across a project. A Data Product Governance Charter defines decision rights, stewardship responsibilities, and quality expectations for an ongoing data product. A Data Sharing Agreement specifies who can access which data, for what purposes, and under what legal, ethical, and governance conditions.

A coordinated approach to stewarding salmon data should follow established open science standards and principles [@johnson2024; @wilkinson2016; @carroll2020], tailored specifically within the context of salmon research and management. Our practices build upon and extend existing data and metadata standards and infrastructure including Darwin Core, OBIS, schema.org, and OBO Foundry ontologies, ensuring compatibility with broader biodiversity informatics infrastructure while avoiding reinventing foundational frameworks. Achieving meaningful interoperability of data among programs, organizations and scientific domains demands both breadth and depth. **Broad interoperability** integrates diverse scientific domains, systems, and formats, requiring structured, machine-readable data and metadata published with clear, machine-readable access conditions to support appropriate discovery and reuse. **Deep interoperability** demands precise definitions of domain-specific terms and methods, ensuring data remains meaningful and usable across contexts.

![Broad interoperability enables exchange and discovery; deep interoperability preserves meaning for integration and reanalysis.](figures/fig-2-broad-vs-deep-interoperability.svg){#fig-interoperability-broad-deep width=85mm}

Salmon data stewards can improve outcomes for salmon by coordinating across boundaries to develop a shared foundation of data stewardship practices. To address these foundational challenges, it is important to establish clear roles and practices that span both the data lifecycle and the salmon life cycle---from collection and documentation through integration, long-term preservation, and reuse, and from gravel to estuary and the high seas back to gravel.
...
::: callout-note
## Box 1: Common Functions of Salmon Data Stewards
...
This case study revisits a comprehensive Sockeye Salmon Oncorhynchus nerka productivity dataset assembled from several agency sources by academic researchers [@peterman2012]. We reflect not on the significant work the research team accomplished, but rather on the preventable organizational and technical barriers that impeded their work—and continue to burden data compilation updates and reuse efforts today. Their study examined productivity trends across 64 Sockeye Salmon stocks spanning Washington, British Columbia (B.C.), and Alaska and found common trends in declining productivity across the North American range of Sockeye Salmon [@peterman2012]. This work was important for sockeye conservation and management because it synthesized productivity information across jurisdictions at a scale that is difficult to achieve without coordinated, cross-program data integration. Attempting to replicate or build upon this analysis today can be time-consuming and error-prone due to fragmented data sources, inconsistent formats, and lack of standardized practices among the key organizations involved: the Washington Department of Fish and Wildlife (WDFW), Fisheries and Oceans Canada (DFO), and the Alaska Department of Fish and Game (ADF&G).

Each section below highlights a key challenge faced by the team and proposes practical steps based on our best-practices framework that data-holding agencies could use to enable easier integration, validation, and updating of salmon datasets across jurisdictions and decades. This case study illustrates how implementing the foundational concepts and practical recommendations outlined in this paper can transform data stewardship practices within these organizations. By doing so, they can significantly enhance data accessibility, quality, and interoperability---ultimately enabling more efficient and accurate analyses that support salmon conservation and management.
...
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+
![Stewardship workflow for publishing and maintaining living data products.](figures/fig-1-living-data-products-workflow.svg){#fig-living-data-products width=85mm}

| Best Practice                                                                                                                                                                                                                                                                                                                      | Next steps (examples)                                                                                                                  |
+:===================================================================================================================================================================================================================================================================================================================================+:=======================================================================================================================================+
...
: Best practices for salmon data stewardship with quick-start next steps {#tbl-bestpractices}
...
We thank collaborators and practitioners from Fisheries and Oceans Canada, the Pacific Salmon Foundation, the Pacific States Marine Fisheries Commission, and the broader salmon data community for constructive feedback and for sharing practical examples that informed this manuscript.

### Data Availability

This manuscript is a synthesis and does not report a newly generated primary dataset. Datasets referenced as examples are available through the cited repositories, landing pages, and DOIs in the text and appendices.

### Code Availability

No new software was developed specifically for this manuscript. Code resources discussed as examples are available at the cited public repositories and archival records.
