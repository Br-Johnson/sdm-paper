...
TODO: Start this more generally framed as Fisheries biologists before diving into salmon specifics..Salmon research, management and conservation increasingly generate vast and diverse data crucial for effective decision making in resource management. Yet, these data remain largely fragmented across jurisdictions, disciplines and outdated infrastructures, limiting their use in responsive fisheries management. Biologists are increasingly taking on the responsibilities of data stewardship to address these challenges, often without clear guidance, training, or support. To address this gap, we share seven best practices for salmon data stewardship and demonstrate their application through a real-world case study. We provide practical guidance for those transitioning into these essential stewardship roles, including domain-specific tools, templates, and examples in salmon research and management. We argue that effective salmon management depends upon formally establishing data stewardship as a dedicated, institutionally-supported professional role. These best practices integrate both sociocultural and technical approaches to ensure salmon data meet modern open science principles and respect Indigenous Data Sovereignty. Through a case-study of a historical sockeye salmon productivity analysis spanning Pacific Coast jurisdictions, we highlight how clearly defined data stewardship practices would enhance data reproducibility, integration, and management efficacy. With a foundation of shared best practices, salmon data stewards will enable faster, more transparent decision-making, support development of tools that leverage recent advances in artificial intelligence, and expand the use of broader, cross-jurisdictional datasets, ---ultimately strengthening the management and conservation of salmon populations and the ecosystems they inhabit.

## Introduction

TODO: Start this more generally framed as Fisheries biologists before diving into salmon specifics.... @noaadatagovernancecommittee2024Salmon biologists generate vast amounts of data on abundance, health, and environmental conditions, yet these data remain fragmented, inconsistently measured, and often incomplete across time, space, and life-history stages—limiting their value for robust research, hypothesis evaluation, and management decision-making [@marmorek2011; @inman2021; @diack2024]. Salmon traverse multiple ecological regions and jurisdictional boundaries, resulting in data collections managed by diverse agencies and institutions, often in isolation and rarely designed for interoperability. This fragmented landscape undermines timely, integrated analyses necessary for effective management and conservation decisions.
